...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-white py-8 md:py-12 px-12">
      ...
      <div className="mt-8 border-t border-gray-600 pt-6 text-center">
        <p className="text-gray-400">&copy; {new Date().getFullYear()} Rooms in Gokhalenagar. All rights reserved.</p>
      </div>
    </footer>
  );
};
